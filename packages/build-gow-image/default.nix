{
  ...
  entrypoint = writeShellScript "entrypoint.sh" ''
    ...
    ${lib.optionalString (compositor == "sway") ''gosu ''${UNAME} sway'' + lib.optionalString (compositor == "gamescope") ''gosu ''${UNAME} gamescope --steam ''${GAMESCOPE_MODE} -W ''${GAMESCOPE_WIDTH} -H ''${GAMESCOPE_HEIGHT} ''$1 -- ${runApp}''}
  '';
in
